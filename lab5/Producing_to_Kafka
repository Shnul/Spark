...
csv_df = spark.read.csv('s3a://lab5/googleplaystore_user_reviews/')
csv_df.write.parquet('s3a://lab5/googleplaystore_user_reviews_parquet/', mode='overwrite')

data_df = spark.read.parquet('s3a://lab5/googleplaystore_user_reviews_parquet/')
